...
function wpsc_display_sales_reports_page() {
kickout('wpsc_display_sales_reports_page', '');
	$reports_page = WPSC_Reports_Page::get_instance();
	$reports_page->display();
}
...
function wpsc_sales_reports_tabs() {
kickout('wpsc_sales_reports_tabs', '');
	return WPSC_Reports_Page::get_instance()->get_tabs();
}
...
function wpsc_the_sales_reports_tabs() {
kickout('wpsc_the_sales_reports_tabs', '');
	WPSC_Reports_Page::get_instance()->output_tabs();
}

function wpsc_sales_reports_page_update_notification() {
